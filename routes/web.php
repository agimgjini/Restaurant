...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/cashier/increase-quantity', 'Cashier\CashierController@increaseQuantity');
    Route::get('/cashier/decrease-quantity', 'Cashier\CashierController@decreaseQuantity');
});
...
Route::middleware(['auth', 'VerifyAdmin'])->group(function(){
    ...
    Route::get('/management',function(){ return view('management.index'); });
